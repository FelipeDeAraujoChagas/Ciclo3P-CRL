...
"")
        ...
        self.frame_4.setGeometry(QtCore.QRect(0, 40, 60, 45))
        ...
        self.frame_5.setGeometry(QtCore.QRect(0, 90, 60, 45))
        ...
        self.frame_6.setGeometry(QtCore.QRect(0, 190, 60, 45))
        ...
        self.frame_8.setGeometry(QtCore.QRect(0, 140, 60, 45))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/folder/cil-folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.stackedWidget.setStyleSheet("QTableView{\n"
...
"")
        ...
        self.frame_7.setGeometry(QtCore.QRect(300, 50, 301, 221))
        ...
        self.lineEdit_1_tratativa.setGeometry(QtCore.QRect(120, 90, 471, 51))
        font = QtGui.QFont()
        ...
        self.lineEdit_2_DtFormatado.setGeometry(QtCore.QRect(120, 190, 471, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.lineEdit_3_BsValidacao.setGeometry(QtCore.QRect(120, 290, 471, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.pushButton_1_trattv_base.setGeometry(QtCore.QRect(670, 90, 121, 41))
        ...
        self.pushButton_2_DataFormatado.setGeometry(QtCore.QRect(670, 200, 121, 41))
        ...
        self.pushButton_3_BaseValidacao.setGeometry(QtCore.QRect(670, 290, 121, 41))
        ...
        self.pushButton_PlayRotina.setGeometry(QtCore.QRect(420, 530, 181, 41))
        ...
        self.lineEdit_4_Ciclo.setGeometry(QtCore.QRect(120, 380, 471, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.pushButton_4_Ciclo.setGeometry(QtCore.QRect(670, 380, 121, 41))
        ...
        self.tableView_usuario.setGeometry(QtCore.QRect(160, 110, 511, 291))
        self.tableView_usuario.setStyleSheet("")
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/olhoMagico/cil-low-vision.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_senhaVisivel.setIcon(icon4)
        ...
        self.pushButton_senha2visivel.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/arrowVoltar/cil-account-logout.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_arrowvoltarUser.setIcon(icon5)
    ...
    def retranslateUi(self, RPA):
        ...
        self.pushButton_messageInserirUser.setText(_translate("RPA", "x"))
